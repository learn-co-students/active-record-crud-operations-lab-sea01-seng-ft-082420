...
def can_be_created_in_a_block(banana= {title: "Home Alone", release_date: 1990})
  ...
  Movie.create do |m|
    m.title = banana[:title]
    m.release_date = banana[:release_date]
  end
end
...
def can_destroy_a_single_item
  mov = Movie.create(title: "That One Where the Guy Kicks Another Guy Once")
  mov.destroy
end
