...
def can_find_using_where_clause_and_be_sorted
  Movie.all.where do |movie|
    movie.release_date > 2002
  end.reorder(release_date: :desc)
...
def can_be_found_updated_and_saved
  ...
  working_title = Movie.all.find_by(title: "Awesome Flick")
  working_title.update(title: "Even Awesomer Flick")
end

def can_update_using_update_method
  # Update movie title to "Wat, huh?"
  Movie.create(title: "Wat?")
  wut = Movie.all.find_by_title("Wat?")
